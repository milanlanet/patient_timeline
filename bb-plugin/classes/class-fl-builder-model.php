...
final class FLBuilderModel {
	...
	static public function save_user_template( $settings = array() )
	{
		...
		update_post_meta($post_id,'original_post_ID',$_REQUEST['fl_builder_data']);
		update_post_meta($post_id,'saved_bb_temp_thumb',get_post_meta($_REQUEST['fl_builder_data']['post_id'],'current_sel_temp_thumb',true));
	...
	static public function apply_user_template($template = null, $append = false)
	{
		if($template) {
			...
			if($template != 'blank') {
				...
				update_post_meta($_REQUEST['fl_builder_data']['post_id'],'_bb_timeline_save_cont',get_post_meta($template_id,'timeline_save_cont',true));
	...
	static public function get_templates()
	{
		...
		update_post_meta(684,'from_dat_file',$templates);
